import {
  ...
  import TablaDatos from "@/components/client/dashboard/administracion/listaDePrecios/tablaDatos";
  ...
  export default async function ListaDePrecios() {
