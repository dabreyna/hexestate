              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="mb-4" action="#" method="POST">
                  <div className="mb-4">
                    ...
                    {/* <Input type="text" className="block w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" id="username" name="email-username" placeholder="ej. dflores" autoFocus /> */}
                    <FormField
                            ...
                            render={({field})=>(
                                <FormItem>
                                    ...
                                    <Input 
                                        {...field}
                                        // disabled={isPending}
                                         className="block w-full cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" id="username" name="email-username" placeholder="ej. dflores" autoFocus />
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                            )
                                ...
                                <FormItem>
                                  <div className="flex justify-between">
                                    ...
                                    <Input 
                                        ...
                                        // disabled={isPending}
                                        type="password"
                                        className="relative block flex-auto cursor-text appearance-none rounded-md border border-gray-400 bg--100 py-2 px-3 text-sm outline-none focus:border-indigo-500 focus:bg-white focus:text-gray-600 focus:shadow" name="password" placeholder="············"  />
                                    </div>
                                    </FormControl>
                                    <FormMessage/>
                                </FormItem>
                  ...
                  <div className="mb-4">
                    <div className="block">
                      {/* <input className="mt-1 mr-2 h-5 w-5 appearance-none rounded border border-gray-300 bg-contain bg-no-repeat align-top text-black shadow checked:bg-indigo-500 focus:border-indigo-500 focus:shadow" type="checkbox" id="remember-me" style={{        backgroundImage: 'url("data:image/svg+xml,%3csvg xmlns=\'http://www.w3.org/20/svg\' viewBox=\'0 0 20 20\'%3e%3cpath fill=\'none\' stroke=\'%23fff\' stroke-linecap=\'round\' stroke-linejoin=\'round\' strokeWidth=\'2\' d=\'M6 10l3 3l6-6\'/%3e%3c/svg%3e")'}} checked /> */}
                      {/* <label className="inline-block" htmlFor="remember-me">Remember Me</label> */}

                    </div>
                  </div>
                  <div className="mb-4">
                    <Button className="grid w-full cursor-pointer select-none rounded-md border border-indigo-500 bg-indigo-500 py-2 px-5 text-center align-middle text-sm text-white shadow hover:border-indigo-600 hover:bg-indigo-600 hover:text-white focus:border-indigo-600 focus:bg-indigo-600 focus:text-white focus:shadow-none" type="submit">Ingresar</Button>
                  </div>
                </form>
              </Form>
